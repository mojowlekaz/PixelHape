...
const Home3 = () => {
  ...
  <button  style={{marginLeft: '10%',width: '100px'}} className="btn">Place Bid</button>
  ...
  <button style={{width: '100px'}} className="btn">Place Bid</button>
  <button style={{marginLeft: '140px'}}  className="btn1">View Artwork</button>
        </div>


  <img className="p"src={require('/Users/user/pixelhape/src/assets/Rectangle 5.png')} /> Los Angeles Based Solo Artist
<br />

  <img className="p"src={require('/Users/user/pixelhape/src/assets/Rectangle 5.png')} /> Collector,Artist,Community Mod and Dedicated Hedera Community Member
